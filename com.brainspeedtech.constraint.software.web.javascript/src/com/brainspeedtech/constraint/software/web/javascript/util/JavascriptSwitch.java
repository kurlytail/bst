...
public class JavascriptSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JavascriptPackage.JAVASCRIPT_GENERATION: {
				JavascriptGeneration javascriptGeneration = (JavascriptGeneration)theEObject;
				Object result = caseJavascriptGeneration(javascriptGeneration);
				if (result == null) result = caseNatureBase(javascriptGeneration);
