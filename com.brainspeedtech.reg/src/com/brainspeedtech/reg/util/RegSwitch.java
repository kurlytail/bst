 ...
 * @generated
 */
public class RegSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RegPackage.REGISTER: {
				Register register = (Register)theEObject;
				T result = caseRegister(register);
				if (result == null) result = caseStruct(register);
				if (result == null) result = caseAtom(register);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RegPackage.REGISTER_INSTANCE: {
				RegisterInstance registerInstance = (RegisterInstance)theEObject;
				T result = caseRegisterInstance(registerInstance);
				if (result == null) result = caseField(registerInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Register Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Register Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRegisterInstance(RegisterInstance object) {
		return null;
	}
