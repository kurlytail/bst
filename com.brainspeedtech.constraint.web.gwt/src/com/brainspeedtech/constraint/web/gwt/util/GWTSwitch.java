...
public class GWTSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GWTPackage.GWT_GENERATION: {
				GWTGeneration gwtGeneration = (GWTGeneration)theEObject;
				Object result = caseGWTGeneration(gwtGeneration);
				if (result == null) result = caseNatureBase(gwtGeneration);
