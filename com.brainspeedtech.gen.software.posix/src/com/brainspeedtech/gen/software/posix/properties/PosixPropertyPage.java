 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.software.posix.properties;
...
public class PosixPropertyPage extends PropertyPage {
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				PosixBuilder.BUILDER_ID, PosixBuilder.PROJECT_LOCATION,
				PosixBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(PosixBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				PosixBuilder.BUILDER_ID,
				PosixBuilder.PROJECT_LOCATION,
				PosixBuilder.DEFAULT_PROJECT_LOCATION);
