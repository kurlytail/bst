 ...
 * <ul>
 *   <li>{@link com.brainspeedtech.struct.impl.AtomImpl#getAtom <em>Atom</em>}</li>
 *   <li>{@link com.brainspeedtech.struct.impl.AtomImpl#getBlurb <em>Blurb</em>}</li>
 *   <li>{@link com.brainspeedtech.struct.impl.AtomImpl#getCount <em>Count</em>}</li>
 *   <li>{@link com.brainspeedtech.struct.impl.AtomImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AtomImpl extends EObjectImpl implements Atom {
	...
	protected EClass eStaticClass() {
		return StructPackage.Literals.ATOM;
	}
		...
		if (atom != null && atom.eIsProxy()) {
			...
			if (atom != oldAtom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StructPackage.ATOM__ATOM, oldAtom, atom));
			}
		}
		return atom;
	}
	...
	public void setAtom(Atom newAtom) {
		...
		atom = newAtom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructPackage.ATOM__ATOM, oldAtom, atom));
	}
	...
	public void setBlurb(String newBlurb) {
		...
		blurb = newBlurb;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructPackage.ATOM__BLURB, oldBlurb, blurb));
	}
	...
	public void setCount(long newCount) {
		...
		countESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructPackage.ATOM__COUNT, oldCount, count, !oldCountESet));
	}
	...
	public void unsetCount() {
		...
		countESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, StructPackage.ATOM__COUNT, oldCount, COUNT_EDEFAULT, oldCountESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructPackage.ATOM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructPackage.ATOM__ATOM:
				if (resolve) return getAtom();
				return basicGetAtom();
			case StructPackage.ATOM__BLURB:
				return getBlurb();
			case StructPackage.ATOM__COUNT:
				return getCount();
			case StructPackage.ATOM__NAME:
				return getName();
		}
