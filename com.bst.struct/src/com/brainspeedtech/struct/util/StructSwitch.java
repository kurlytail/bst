 ...
 * @generated
 */
public class StructSwitch<T> extends Switch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StructPackage.ENUM: {
				com.brainspeedtech.struct.Enum enum_ = (com.brainspeedtech.struct.Enum)theEObject;
				T result = caseEnum(enum_);
				if (result == null) result = caseAtom(enum_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StructPackage.STRUCT: {
				...
				if (result == null) result = caseAtom(struct);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseEnum(com.brainspeedtech.struct.Enum object) {
		return null;
	}
