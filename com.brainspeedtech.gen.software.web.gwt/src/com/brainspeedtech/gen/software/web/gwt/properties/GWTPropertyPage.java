package com.brainspeedtech.gen.software.web.gwt.properties;
...
import com.brainspeedtech.gen.software.web.gwt.builder.GWTBuilder;
import com.brainspeedtech.swarm.project.transaction.SwarmEditingDomainFactory;

public class GWTPropertyPage extends PropertyPage {
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				GWTBuilder.BUILDER_ID, GWTBuilder.PROJECT_LOCATION,
				GWTBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(GWTBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				GWTBuilder.BUILDER_ID,
				GWTBuilder.PROJECT_LOCATION,
				GWTBuilder.DEFAULT_PROJECT_LOCATION);
