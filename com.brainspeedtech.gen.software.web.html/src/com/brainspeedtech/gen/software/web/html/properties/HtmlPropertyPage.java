 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.software.web.html.properties;
...
import com.brainspeedtech.gen.software.web.html.builder.HtmlBuilder;
import com.brainspeedtech.swarm.project.transaction.SwarmEditingDomainFactory;

public class HtmlPropertyPage extends PropertyPage {
	 ...
	 */
	public HtmlPropertyPage() {
		super();
		setTitle("Html Preferences");
	}
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				HtmlBuilder.BUILDER_ID, HtmlBuilder.PROJECT_LOCATION,
				HtmlBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(HtmlBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				HtmlBuilder.BUILDER_ID,
				HtmlBuilder.PROJECT_LOCATION,
				HtmlBuilder.DEFAULT_PROJECT_LOCATION);
