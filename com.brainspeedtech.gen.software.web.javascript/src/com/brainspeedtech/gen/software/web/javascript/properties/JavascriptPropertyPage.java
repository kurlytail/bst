 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.software.web.javascript.properties;
...
import com.brainspeedtech.gen.software.web.javascript.builder.JavascriptBuilder;
...
public class JavascriptPropertyPage extends PropertyPage {
	...
	public JavascriptPropertyPage() {
		super();
		setTitle("Javascript Preferences");
	}
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				JavascriptBuilder.BUILDER_ID, JavascriptBuilder.PROJECT_LOCATION,
				JavascriptBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(JavascriptBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				JavascriptBuilder.BUILDER_ID,
				JavascriptBuilder.PROJECT_LOCATION,
				JavascriptBuilder.DEFAULT_PROJECT_LOCATION);
