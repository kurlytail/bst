package com.brainspeedtech.gen.software.opencl.properties;
...
import com.brainspeedtech.gen.software.opencl.builder.OpenCLBuilder;
import com.brainspeedtech.swarm.project.transaction.SwarmEditingDomainFactory;

public class OpenCLPropertyPage extends PropertyPage {
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				OpenCLBuilder.BUILDER_ID, OpenCLBuilder.PROJECT_LOCATION,
				OpenCLBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(OpenCLBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				OpenCLBuilder.BUILDER_ID,
				OpenCLBuilder.PROJECT_LOCATION,
				OpenCLBuilder.DEFAULT_PROJECT_LOCATION);
