...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.swarm.layer.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_tube_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_tube_feature", "_UI_Association_type"),
				 LayerPackage.Literals.ASSOCIATION__TUBE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayerPackage.Literals.ASSOCIATION__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Association_type") + " " + association.getBlurb();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Association.class)) {
			case LayerPackage.ASSOCIATION__TYPE:
