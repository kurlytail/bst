...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.swarm.layer.ModelReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelReferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelReference_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelReference_object_feature", "_UI_ModelReference_type"),
				 LayerPackage.Literals.MODEL_REFERENCE__OBJECT,
				 true,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		ModelReference modelReference = (ModelReference)object;
		return getString("_UI_ModelReference_type") + " " + modelReference.getBlurb();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModelReference.class)) {
			case LayerPackage.MODEL_REFERENCE__OBJECT:
