...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.swarm.layer.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_object_feature", "_UI_Parameter_type"),
				 LayerPackage.Literals.PARAMETER__OBJECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayerPackage.Literals.PARAMETER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LayerPackage.Literals.PARAMETER__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_Parameter_type") + " " + label + value;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Parameter.class)) {
			case LayerPackage.PARAMETER__NAME:
			case LayerPackage.PARAMETER__VALUE:
