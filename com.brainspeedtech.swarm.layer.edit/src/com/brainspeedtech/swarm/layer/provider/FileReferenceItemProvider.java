...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.swarm.layer.FileReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileReferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FileReference_files_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FileReference_files_feature", "_UI_FileReference_type"),
				 LayerPackage.Literals.FILE_REFERENCE__FILES,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FileReference"));
	}
	...
	public String getText(Object object) {
		FileReference fileReference = (FileReference)object;
		return getString("_UI_FileReference_type") + " " + fileReference.isApplyToAllNatures();
	}
