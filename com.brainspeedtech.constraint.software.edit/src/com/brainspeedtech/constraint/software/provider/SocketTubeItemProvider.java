...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.constraint.software.SocketTube} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SocketTubeItemProvider
	 ...
	 * @generated
	 */
	public SocketTubeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SocketTube_tube_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SocketTube_tube_feature", "_UI_SocketTube_type"),
				 SoftwarePackage.Literals.SOCKET_TUBE__TUBE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addClientReceiverPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SocketTube_clientReceiver_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SocketTube_clientReceiver_feature", "_UI_SocketTube_type"),
				 SoftwarePackage.Literals.SOCKET_TUBE__CLIENT_RECEIVER,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SocketTube"));
	}
	...
	public String getText(Object object) {
		SocketTube socketTube = (SocketTube)object;
		return getString("_UI_SocketTube_type") + " " + socketTube.getBlurb();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SocketTube.class)) {
