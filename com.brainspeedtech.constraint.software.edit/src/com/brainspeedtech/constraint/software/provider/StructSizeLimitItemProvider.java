...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.constraint.software.StructSizeLimit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructSizeLimitItemProvider
	 ...
	 * @generated
	 */
	public StructSizeLimitItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructSizeLimit_structure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructSizeLimit_structure_feature", "_UI_StructSizeLimit_type"),
				 SoftwarePackage.Literals.STRUCT_SIZE_LIMIT__STRUCTURE,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addLimitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructSizeLimit_limit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructSizeLimit_limit_feature", "_UI_StructSizeLimit_type"),
				 SoftwarePackage.Literals.STRUCT_SIZE_LIMIT__LIMIT,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns StructSizeLimit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StructSizeLimit"));
	}
	...
	public String getText(Object object) {
		StructSizeLimit structSizeLimit = (StructSizeLimit)object;
		return getString("_UI_StructSizeLimit_type") + " " + structSizeLimit.getBlurb();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StructSizeLimit.class)) {
