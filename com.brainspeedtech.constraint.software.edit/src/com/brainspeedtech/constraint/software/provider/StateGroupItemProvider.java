...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.constraint.software.StateGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateGroupItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StateGroup_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StateGroup_state_feature", "_UI_StateGroup_type"),
				 SoftwarePackage.Literals.STATE_GROUP__STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StateGroup_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StateGroup_name_feature", "_UI_StateGroup_type"),
				 SoftwarePackage.Literals.STATE_GROUP__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((StateGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StateGroup_type") :
			getString("_UI_StateGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StateGroup.class)) {
			case SoftwarePackage.STATE_GROUP__NAME:
