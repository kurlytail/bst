...
public class MasterSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MasterPackage.MASTER_CELL: {
				MasterCell masterCell = (MasterCell)theEObject;
				T result = caseMasterCell(masterCell);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasterPackage.MASTER_DESIGN: {
				MasterDesign masterDesign = (MasterDesign)theEObject;
				T result = caseMasterDesign(masterDesign);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasterPackage.MASTER_TUBE: {
				MasterTube masterTube = (MasterTube)theEObject;
				T result = caseMasterTube(masterTube);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseMasterCell(MasterCell object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseMasterDesign(MasterDesign object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseMasterTube(MasterTube object) {
		return null;
	}
