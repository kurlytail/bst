...
public class HtmlSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HtmlPackage.HTML_GENERATION: {
				HtmlGeneration htmlGeneration = (HtmlGeneration)theEObject;
				Object result = caseHtmlGeneration(htmlGeneration);
				if (result == null) result = caseNatureBase(htmlGeneration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HtmlPackage.INDEX_PAGE: {
				IndexPage indexPage = (IndexPage)theEObject;
				Object result = caseIndexPage(indexPage);
				if (result == null) result = caseConstraintBase(indexPage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
