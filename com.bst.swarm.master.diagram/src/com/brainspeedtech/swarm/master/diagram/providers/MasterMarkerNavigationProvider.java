...
import com.brainspeedtech.swarm.master.diagram.part.MasterDiagramEditorUtil;

/**
 * @generated
 */
public class MasterMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = MasterDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			MasterDiagramEditorUtil.selectElementsInDiagram(editor,
