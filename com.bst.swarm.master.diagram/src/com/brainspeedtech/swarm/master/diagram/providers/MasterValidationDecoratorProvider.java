...
import com.brainspeedtech.swarm.master.diagram.part.MasterDiagramEditor;
 ...
 * @generated
 */
public class MasterValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = MasterDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof MasterDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& MasterDesignEditPart.MODEL_ID.equals(MasterVisualIDRegistry
						.getModelID(view));
	}
		...
		private String getView(String objectid) {
			...
			while (iterator.hasNext()) {
				...
				if (object instanceof Shape) {
					...
					if (shape.getElement() != null && resource != null
							&& resource.getID(shape.getElement()) != null) {
