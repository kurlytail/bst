 ...
 * @generated
 */
public class MasterCellNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MasterCellNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new MasterDesignEditPart.NodeLabelDragPolicy());
	}
			...
			parser = MasterParserProvider
					.getParser(
							...
							MasterVisualIDRegistry
									.getType(com.brainspeedtech.swarm.master.diagram.edit.parts.MasterCellNameEditPart.VISUAL_ID));
		}
		return parser;
	}
