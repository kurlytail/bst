...
import com.brainspeedtech.swarm.master.diagram.edit.policies.MasterTextSelectionEditPolicy;
 ...
 * @generated
 */
public class MasterTubeNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MasterVisualIDRegistry
						.getType(com.brainspeedtech.swarm.master.diagram.edit.parts.MasterTubeNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public MasterTubeNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MasterTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new MasterDesignEditPart.LinkLabelDragPolicy());
	}
	...
	protected String getLabelText() {
		...
		if (!(parserElement instanceof MasterTube)) {
			return defaultText;
		}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					MasterEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
