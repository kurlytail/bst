 ...
 * @generated
 */
public class MasterEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case MasterDesignEditPart.VISUAL_ID:
				return new MasterDesignEditPart(view);

			case MasterCellEditPart.VISUAL_ID:
				return new MasterCellEditPart(view);

			case MasterCellNameEditPart.VISUAL_ID:
				return new MasterCellNameEditPart(view);

			case MasterTubeEditPart.VISUAL_ID:
				return new MasterTubeEditPart(view);

			case MasterTubeNameEditPart.VISUAL_ID:
				return new MasterTubeNameEditPart(view);
