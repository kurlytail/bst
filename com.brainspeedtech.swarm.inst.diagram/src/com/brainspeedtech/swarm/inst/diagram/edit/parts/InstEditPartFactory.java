 ...
 * @generated
 */
public class InstEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case CellInstanceEditPart.VISUAL_ID:
				return new CellInstanceEditPart(view);

			case CellInstanceNameEditPart.VISUAL_ID:
				return new CellInstanceNameEditPart(view);

			case TubeInstanceEditPart.VISUAL_ID:
				return new TubeInstanceEditPart(view);

			case TubeInstanceNameEditPart.VISUAL_ID:
				return new TubeInstanceNameEditPart(view);
