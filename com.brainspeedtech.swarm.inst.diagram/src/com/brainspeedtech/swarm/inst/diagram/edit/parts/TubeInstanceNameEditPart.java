...
import com.brainspeedtech.swarm.inst.diagram.edit.policies.InstTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TubeInstanceNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				InstVisualIDRegistry
						.getType(com.brainspeedtech.swarm.inst.diagram.edit.parts.TubeInstanceNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TubeInstanceNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new InstTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new InstanceEditPart.LinkLabelDragPolicy());
	}
	...
	protected String getLabelText() {
		...
		if (!(parserElement instanceof TubeInstance)) return defaultText;
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					InstEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
