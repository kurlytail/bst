 ...
 * @generated
 */
public class CellInstanceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CellInstanceNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new InstanceEditPart.NodeLabelDragPolicy());
	}
			...
			parser = InstParserProvider
					.getParser(
							...
							InstVisualIDRegistry
									.getType(com.brainspeedtech.swarm.inst.diagram.edit.parts.CellInstanceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
