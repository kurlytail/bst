...
import com.brainspeedtech.swarm.inst.diagram.part.InstDiagramEditor;
 ...
 * @generated
 */
public class InstValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = InstDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof InstDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& InstanceEditPart.MODEL_ID.equals(InstVisualIDRegistry
						.getModelID(view));
	}
