...
import com.brainspeedtech.swarm.inst.diagram.part.InstDiagramEditorUtil;

/**
 * @generated
 */
public class InstMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = InstDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			InstDiagramEditorUtil.selectElementsInDiagram(editor,
