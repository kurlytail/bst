 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.software.java.properties;
...
import com.brainspeedtech.gen.software.java.builder.JavaBuilder;
...
public class JavaPropertyPage extends PropertyPage {
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				JavaBuilder.BUILDER_ID, JavaBuilder.PROJECT_LOCATION,
				JavaBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(JavaBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				JavaBuilder.BUILDER_ID,
				JavaBuilder.PROJECT_LOCATION,
				JavaBuilder.DEFAULT_PROJECT_LOCATION);
