 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.software.mray.properties;
...
import com.brainspeedtech.gen.software.mray.builder.MrayBuilder;
import com.brainspeedtech.swarm.project.transaction.SwarmEditingDomainFactory;

public class MrayPropertyPage extends PropertyPage {
	 ...
	 */
	public MrayPropertyPage() {
		super();
		setTitle("Mray Preferences");
	}
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				MrayBuilder.BUILDER_ID, MrayBuilder.PROJECT_LOCATION,
				MrayBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(MrayBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				MrayBuilder.BUILDER_ID,
				MrayBuilder.PROJECT_LOCATION,
				MrayBuilder.DEFAULT_PROJECT_LOCATION);
