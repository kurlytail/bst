 ...
 * @generated
 */
public class SmInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SmNewDiagramFileWizard(domainModelURI, diagramRoot,
				editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				StateMachineEditPart.MODEL_ID));
		SmDiagramEditorUtil.runWizard(getShell(), wizard, "InitDiagramFile"); //$NON-NLS-1$
	}
}
