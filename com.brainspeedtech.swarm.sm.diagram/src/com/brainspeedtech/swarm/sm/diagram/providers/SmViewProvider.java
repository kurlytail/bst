 ...
 * @generated
 */
public class SmViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return StateMachineEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& SmVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SmVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = SmVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!SmElementTypes.isKnownElementType(elementType)
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = SmVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != SmVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = SmVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = SmVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case StateEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SmVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createState_2001(EObject domainElement, View containerView,
		...
		node.setType(SmVisualIDRegistry.getType(StateEditPart.VISUAL_ID));
	...
	public Edge createTransition_4001(EObject domainElement,
		...
		edge.setType(SmVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
