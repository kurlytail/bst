...
import com.brainspeedtech.swarm.sm.diagram.part.SmDiagramEditorUtil;

/**
 * @generated
 */
public class SmMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = SmDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			SmDiagramEditorUtil.selectElementsInDiagram(editor,
