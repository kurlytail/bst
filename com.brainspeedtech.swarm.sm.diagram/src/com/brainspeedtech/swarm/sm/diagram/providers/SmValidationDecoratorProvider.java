...
import com.brainspeedtech.swarm.sm.diagram.part.SmDiagramEditor;
 ...
 * @generated
 */
public class SmValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = SmDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof SmDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& StateMachineEditPart.MODEL_ID.equals(SmVisualIDRegistry
						.getModelID(view));
	}
		...
		private String getView(String objectid) {
			...
			while (iterator.hasNext()) {
				...
				if (object instanceof Shape) {
					...
					if (resource.getID(shape.getElement()) == null)
						continue;
