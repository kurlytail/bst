...
import com.brainspeedtech.swarm.sm.diagram.edit.policies.StateMachineCanonicalEditPolicy;
import com.brainspeedtech.swarm.sm.diagram.edit.policies.StateMachineItemSemanticEditPolicy;
...
public class StateMachineEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Sm"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						SmVisualIDRegistry.TYPED_INSTANCE));
