...
import com.brainspeedtech.swarm.sm.diagram.edit.policies.SmTextSelectionEditPolicy;
...
public class StateNameEditPart extends CompartmentEditPart implements
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SmParserProvider
					.getParser(
							SmElementTypes.State_2001,
							getParserElement(),
							SmVisualIDRegistry
									.getType(com.brainspeedtech.swarm.sm.diagram.edit.parts.StateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					SmEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
