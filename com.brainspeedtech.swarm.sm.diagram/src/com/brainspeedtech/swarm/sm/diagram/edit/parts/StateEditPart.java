...
import com.brainspeedtech.swarm.sm.diagram.edit.policies.StateItemSemanticEditPolicy;
...
public class StateEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(SmVisualIDRegistry
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof com.brainspeedtech.swarm.sm.diagram.edit.parts.StateEditPart) {
			types.add(SmElementTypes.Transition_4001);
		}
		return types;
	}
