 ...
 * All rights reserved.
 ******************************************************************************/
package com.bst.gen.tcl.properties;
...
import com.brainspeedtech.gen.tcl.builder.SwarmTclBuilder;
...
public class TclPropertyPage extends PropertyPage {
	 ...
	 */
	public TclPropertyPage() {
		super();
		setTitle("Tcl Preferences");
	}
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				SwarmTclBuilder.BUILDER_ID, SwarmTclBuilder.PROJECT_LOCATION,
				SwarmTclBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(SwarmTclBuilder.DEFAULT_PROJECT_LOCATION);
	}

	public boolean performOk() {
		IProject project = (IProject) getElement();
		if (projectLocation.getEnabled())
			SwarmEditingDomainFactory
					.setBuilderOption(project, SwarmTclBuilder.BUILDER_ID,
							SwarmTclBuilder.PROJECT_LOCATION,
