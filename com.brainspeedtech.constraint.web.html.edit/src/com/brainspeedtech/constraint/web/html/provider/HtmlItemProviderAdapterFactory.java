...
import com.brainspeedtech.constraint.web.html.util.HtmlAdapterFactory;
 ...
 * @generated
 */
public class HtmlItemProviderAdapterFactory extends HtmlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(HtmlEditPlugin.INSTANCE, HtmlPackage.eNS_URI);
	...
	/**
	 * This keeps track of the one adapter used for all {@link com.brainspeedtech.constraint.web.html.HtmlGeneration} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected HtmlGenerationItemProvider htmlGenerationItemProvider;

	/**
	 * This creates an adapter for a {@link com.brainspeedtech.constraint.web.html.HtmlGeneration}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Adapter createHtmlGenerationAdapter() {
		if (htmlGenerationItemProvider == null) {
			htmlGenerationItemProvider = new HtmlGenerationItemProvider(this);
		}

		return htmlGenerationItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link com.brainspeedtech.constraint.web.html.IndexPage} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link com.brainspeedtech.constraint.web.html.IndexPage}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 */
	public void dispose() {
		if (htmlGenerationItemProvider != null) htmlGenerationItemProvider.dispose();
				...
				newChildDescriptors.add
					(createChildParameter
						(LayerPackage.Literals.LAYER__CONSTRAINT,
						 HtmlFactory.eINSTANCE.createIndexPage()));
