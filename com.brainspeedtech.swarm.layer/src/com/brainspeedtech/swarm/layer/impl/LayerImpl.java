 ...
 * <ul>
 *   <li>{@link com.brainspeedtech.swarm.layer.impl.LayerImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link com.brainspeedtech.swarm.layer.impl.LayerImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LayerImpl extends EObjectImpl implements Layer {
	 ...
	 * @ordered
	 */
	protected EList<ConstraintBase> constraint;
	 ...
	 * @generated
	 */
	public EList<ConstraintBase> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<ConstraintBase>(ConstraintBase.class, this, LayerPackage.LAYER__CONSTRAINT);
		}
		return constraint;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case LayerPackage.LAYER__CONSTRAINT:
				getConstraint().clear();
				getConstraint().addAll((Collection<? extends ConstraintBase>)newValue);
				return;
			case LayerPackage.LAYER__NAME:
