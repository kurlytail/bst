...
public class FlowElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Flow_1000 = getElementType("com.brainspeedtech.swarm.flow.diagram.Flow_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Cell_2001 = getElementType("com.brainspeedtech.swarm.flow.diagram.Cell_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Tube_4001 = getElementType("com.brainspeedtech.swarm.flow.diagram.Tube_4001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Cell_2001, FlowPackage.eINSTANCE.getCell());

			elements.put(Tube_4001, FlowPackage.eINSTANCE.getTube());
		}
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Cell_2001);
			KNOWN_ELEMENT_TYPES.add(Tube_4001);
		}
