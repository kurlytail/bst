 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.html.properties;
...
import com.brainspeedtech.gen.html.builder.DocBuilder;
...
public class HTMLPropertyPage extends PropertyPage {
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				DocBuilder.BUILDER_ID, DocBuilder.PROJECT_LOCATION,
				DocBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(DocBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				DocBuilder.BUILDER_ID,
				DocBuilder.PROJECT_LOCATION,
				DocBuilder.DEFAULT_PROJECT_LOCATION);
