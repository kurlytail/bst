...
public class HTMLStructFile
{
  ...
  protected final String TEXT_12 = "</a>";
  protected final String TEXT_13 = NL + "\t\t\t\tbit";
  protected final String TEXT_14 = NL + "\t\t\t";
  protected final String TEXT_15 = " Bytes";
  protected final String TEXT_16 = " Bit";
  protected final String TEXT_17 = NL + "\t\t</td>" + NL + "\t\t<td>" + NL + "\t\t\t";
  protected final String TEXT_18 = NL + "\t\t</td>" + NL + "\t</tr>";
  protected final String TEXT_19 = NL + "\t</table>";
  protected final String TEXT_20 = NL + "\t<table border=\"1\" cellpadding=\"5\" cellspacing=\"0\">" + NL + "\t<tr>" + NL + "\t\t<th>" + NL + "\t\t\tEnumeration" + NL + "\t\t</th>" + NL + "\t\t<th>" + NL + "\t\t\tValue" + NL + "\t\t</th>" + NL + "\t\t<th>" + NL + "\t\t\tDescription" + NL + "\t\t</th>" + NL + "\t</tr>";
  protected final String TEXT_21 = NL + NL + "</body>" + NL + "</html>";
