...
public class PythonSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PythonPackage.PY_PACKAGE: {
				PyPackage pyPackage = (PyPackage)theEObject;
				Object result = casePyPackage(pyPackage);
				if (result == null) result = caseConstraintBase(pyPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PythonPackage.PYTHON_GENERATOR: {
				PythonGenerator pythonGenerator = (PythonGenerator)theEObject;
				Object result = casePythonGenerator(pythonGenerator);
				if (result == null) result = caseNatureBase(pythonGenerator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Py Package</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Py Package</em>'.
