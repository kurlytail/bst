...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>No Init Handler</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.brainspeedtech.constraint.software.impl.NoInitHandlerImpl#getCell <em>Cell</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NoInitHandlerImpl extends ConstraintBaseImpl implements NoInitHandler {
	/**
	...
	protected EClass eStaticClass() {
		return SoftwarePackage.Literals.NO_INIT_HANDLER;
	}
	...
	public EList<MasterCell> getCell() {
		if (cell == null) {
			cell = new EObjectResolvingEList<MasterCell>(MasterCell.class, this, SoftwarePackage.NO_INIT_HANDLER__CELL);
		}
		return cell;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SoftwarePackage.NO_INIT_HANDLER__CELL:
				return getCell();
		}
