 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.software.posix.vpi.properties;
...
import com.brainspeedtech.gen.software.posix.vpi.builder.VPIBuilder;
import com.brainspeedtech.swarm.project.transaction.SwarmEditingDomainFactory;

public class PosixPropertyPage extends PropertyPage {
	private Text projectLocation;
	private Button btnVariables;

	public PosixPropertyPage() {
		setTitle("Posix Preferences");
	}
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				VPIBuilder.BUILDER_ID, VPIBuilder.PROJECT_LOCATION,
				VPIBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(VPIBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				VPIBuilder.BUILDER_ID,
				VPIBuilder.PROJECT_LOCATION,
				VPIBuilder.DEFAULT_PROJECT_LOCATION);
