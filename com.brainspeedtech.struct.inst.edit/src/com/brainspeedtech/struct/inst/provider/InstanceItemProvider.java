 ...
 * $Id$
 */
package com.brainspeedtech.struct.inst.provider;
...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.struct.inst.Instance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instance_count_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_count_feature", "_UI_Instance_type"),
				 InstPackage.Literals.INSTANCE__COUNT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InstPackage.Literals.INSTANCE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addStructPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instance_struct_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_struct_feature", "_UI_Instance_type"),
				 InstPackage.Literals.INSTANCE__STRUCT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InstPackage.Literals.INSTANCE__TERMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InstPackage.Literals.INSTANCE__TERMS,
				 InstFactory.eINSTANCE.createInstanceTerm()));
	}
