...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.struct.Struct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructPackage.Literals.STRUCT__FIELD);
		}
	...
	public String getText(Object object) {
		...
		if (((Struct)object).eResource() != null) {
			label += " --> " + ((Struct)object).eResource().getURI().lastSegment() ;
		}
		return label;
...
//			getString("_UI_Struct_type") + " " + label;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Struct.class)) {
			case StructPackage.STRUCT__FIELD:
		...
		newChildDescriptors.add
			(createChildParameter
				(StructPackage.Literals.STRUCT__FIELD,
				 StructFactory.eINSTANCE.createField()));
	}
