...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.struct.Path} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Path_field_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Path_field_feature", "_UI_Path_type"),
				 StructPackage.Literals.PATH__FIELD,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Path_index_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Path_index_feature", "_UI_Path_type"),
				 StructPackage.Literals.PATH__INDEX,
				 true,
				 false,
				 false,
	...
	protected void addRangePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Path_range_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Path_range_feature", "_UI_Path_type"),
				 StructPackage.Literals.PATH__RANGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructPackage.Literals.PATH__CHILD);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Path_type") + " " + path.getIndex();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructPackage.Literals.PATH__CHILD,
				 StructFactory.eINSTANCE.createPath()));
	}
