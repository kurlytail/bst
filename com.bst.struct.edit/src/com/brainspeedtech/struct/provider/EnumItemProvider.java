...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.struct.Enum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructPackage.Literals.ENUM__TERM);
		}
	...
	public String getText(Object object) {
		String label = ((com.brainspeedtech.struct.Enum)object).getName();
...
//			getString("_UI_Enum_type") + " " + label;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(com.brainspeedtech.struct.Enum.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructPackage.Literals.ENUM__TERM,
				 StructFactory.eINSTANCE.createEnumTerm()));
	}
