...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.struct.Atom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atom_atom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atom_atom_feature", "_UI_Atom_type"),
				 StructPackage.Literals.ATOM__ATOM,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBlurbPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atom_blurb_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atom_blurb_feature", "_UI_Atom_type"),
				 StructPackage.Literals.ATOM__BLURB,
				 true,
				 true,
				 false,
	...
	protected void addCountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atom_count_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atom_count_feature", "_UI_Atom_type"),
				 StructPackage.Literals.ATOM__COUNT,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atom_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atom_name_feature", "_UI_Atom_type"),
				 StructPackage.Literals.ATOM__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
