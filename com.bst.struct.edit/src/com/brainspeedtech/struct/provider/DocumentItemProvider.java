...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.struct.Document} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGhostPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Ghost feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGhostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Document_ghost_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Document_ghost_feature", "_UI_Document_type"),
				 StructPackage.Literals.DOCUMENT__GHOST,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructPackage.Literals.DOCUMENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructPackage.Literals.DOCUMENT__STRUCT);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(StructPackage.Literals.DOCUMENT__STRUCT,
				 StructFactory.eINSTANCE.createAtom()));

		newChildDescriptors.add
			(createChildParameter
				(StructPackage.Literals.DOCUMENT__STRUCT,
				 StructFactory.eINSTANCE.createEnum()));

		newChildDescriptors.add
			(createChildParameter
				(StructPackage.Literals.DOCUMENT__STRUCT,
				 StructFactory.eINSTANCE.createStruct()));
	}
