...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Custom Posix Tube</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.brainspeedtech.constraint.software.posix.impl.CustomPosixTubeImpl#getTube <em>Tube</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CustomPosixTubeImpl extends ConstraintBaseImpl implements CustomPosixTube {
	/**
	...
	protected EClass eStaticClass() {
		return PosixPackage.Literals.CUSTOM_POSIX_TUBE;
	}
	...
	public EList getTube() {
		if (tube == null) {
			tube = new EObjectResolvingEList(MasterTube.class, this, PosixPackage.CUSTOM_POSIX_TUBE__TUBE);
		}
		return tube;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PosixPackage.CUSTOM_POSIX_TUBE__TUBE:
				return getTube();
		}
