...
public class TclSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TclPackage.TCL_GENERATION: {
				TclGeneration tclGeneration = (TclGeneration)theEObject;
				Object result = caseTclGeneration(tclGeneration);
				if (result == null) result = caseNatureBase(tclGeneration);
