 ...
 * All rights reserved.
 ******************************************************************************/
package com.brainspeedtech.gen.software.python.properties;
...
import com.brainspeedtech.gen.software.python.builder.PythonBuilder;
...
public class PythonPropertyPage extends PropertyPage {
	...
	private void initializeProperties() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				PythonBuilder.BUILDER_ID, PythonBuilder.PROJECT_LOCATION,
				PythonBuilder.DEFAULT_PROJECT_LOCATION);
		if (pLocation == null) {
	...
	protected void performDefaults() {
		...
		projectLocation.setText(PythonBuilder.DEFAULT_PROJECT_LOCATION);
	}
	...
	public boolean okToLeave() {
		...
		String pLocation = SwarmEditingDomainFactory.getBuilderOption(project,
				PythonBuilder.BUILDER_ID,
				PythonBuilder.PROJECT_LOCATION,
				PythonBuilder.DEFAULT_PROJECT_LOCATION);
