...
/**
 * This is the item provider adapter for a {@link com.brainspeedtech.constraint.software.java.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Package_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Package_object_feature", "_UI_Package_type"),
				 JavaPackage.Literals.PACKAGE__OBJECT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((com.brainspeedtech.constraint.software.java.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(com.brainspeedtech.constraint.software.java.Package.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LayerPackage.Literals.CONSTRAINT_BASE__EXCEPT_FOR,
				 JavaFactory.eINSTANCE.createJavaGenerator()));
	}
