...
public class JavaSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JavaPackage.JAVA_GENERATOR: {
				JavaGenerator javaGenerator = (JavaGenerator)theEObject;
				Object result = caseJavaGenerator(javaGenerator);
				if (result == null) result = caseNatureBase(javaGenerator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JavaPackage.PACKAGE: {
				com.brainspeedtech.constraint.software.java.Package package_ = (com.brainspeedtech.constraint.software.java.Package)theEObject;
				Object result = casePackage(package_);
				if (result == null) result = caseConstraintBase(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
